...
public class BedService {
    ...
    private final String CREATE_TABLE_SQL = "CREATE TABLE Bed (id bigint GENERATED BY DEFAULT AS IDENTITY, name VARCHAR(25), weight DOUBLE, productionDate DATE, isWood BOOLEAN)";
    ...
    public BedService() throws SQLException {
        ...
        addBedStmt = connection.prepareStatement("INSERT INTO Bed (name, weight, productionDate, isSoft) VALUES (?,?,?,?)");
